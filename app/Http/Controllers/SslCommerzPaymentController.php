...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data['upzilla_id'] = $request->upzilla_id;
        $post_data['notes'] = $request->notes;
        $post_data['payment_method'] = "SSL Payment";
        $post_data['invoice_no'] = 'SPM'.mt_rand(100000000,999999999);
        ...
        $update_product = DB::table('orders')
            ...
            ->updateOrInsert([
                ...
                'upzilla_id' => $post_data['upzilla_id'],
    ...
    public function payViaAjax(Request $request)
    {
        ...
        $post_data['upzilla_id'] = $requestData['upzilla_id'];
