                            ...
                            <div class="col-md-6">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        @php
                                            $order_r = App\Models\Order::where('id', $order->id)
                                        ...
                                        @if (!$order_r)
                                            ...
                                            <span class="badge badge-pill badge-warning"
                                                style="background: red; text:white;">You Have Send a Return Request</span>
                                        @endif
                                    </li>
                                                    ...
                                                    <tr>
                                                        <td class="col-md-1">
                                                            <img src="{{ asset($item->product->product_thumbnail) }}"
                                                                height="50px;" width="50px;" alt="imga">
                                                        </td>
                                                        <td class="col-md-3">
                                                        ...
                                                        <td class="col-md-1">
                                                            ...
                                                            @if ($order->status == 'delivered')
                                                        <td class="col-md-1">
                                                            <a href="{{ url('user/review-create/' . $item->product_id) }}">write
                                                                a review</a>
                                                        </td>
                                                @endif
                                ...
                                @if ($order)
                                    <form action="{{ route('user-return-order') }}" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="return_reason" id="label" class="form-control" cols="30" rows="05"
                                                placeholder="Return Reason"></textarea>
                                        </div>
