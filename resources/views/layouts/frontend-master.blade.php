...
<body class="cnt-home">
                    ...
                    <div class="cnt-block">
                        <ul class="list-unstyled list-inline">
                            <li class="dropdown dropdown-small">
                                ...
                                <a href="" type="button" class="dropdown-toggle" data-toggle="modal"
                                    data-target="#exampleModal">
                                    <span class="value">Order track</span>
                                </a>
                            </li>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('order.track') }}" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-success">Order Track</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                                                                        ...
                                                                        @foreach ($subsubcategories as $subsubcat)
                                                                            <li>
                                                                                <a
                                                                                    ...
                                                                                    @if (session()->get('language') == 'bangla')
                                                                                        {{ $subsubcat->subsubcategory_name_bn }}
                                                                                    @else
                        ...
                        <div class="col-md-4">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">Stock:
                                    <span id="available" class="badge badge-pill badge-success"
                                        style="background:green;color:white"></span>
                                    <span id="stockout" class="badge badge-pill badge-danger"
    ...
    <script src="{{ asset('common') }}/jquery.form-validation.min.js"></script>
    <script>
        $.validate({
            lang: 'en'
        });
                ...
                success: function(response) {
                    ...
                    $.each(response, function(key, value) {
                        rows += `<tr>
                                        ...
                                        <td class="col-md-2">
                                            <button id="${value.Product_id}" class="btn btn-primary icon"
                                        ...
                                        <td class="col-md-1 close-btn">
                                            <button type="submit"id="${value.id}" onclick="wishlitRemove(this.id)"><i class="fa fa-trash"></i></button>
                                        </td>
                                    </tr>`
                    });
                    $('#wishlist').html(rows)
                ...
                success: function(response) {
                    ...
                    $.each(response.carts, function(key, value) {
                        rows += `<tr>
                                        ...
                                        <td class="col-md-3">
                                            ${value.qty > 1
                                              ? `<button type="submit" id="${value.rowId}" onclick="cartDecrement(this.id)" class="btn btn-success btn-sm">-</button>`
