                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 sign-in">
                        ...
                        <div class="social-sign-in outer-top-xs">
                            <a href="{{ route('login.google') }}" class="google-sign-in">
                                <h4 style="background-color: black;color:white; padding:12px;"><i
                                        class="fa fa-google"></i>Sign In With
                                    Google</h4>
                            </a>
                            <a href="{{ route('login.facebook') }}" class="facebook-sign-in"><i class="fa fa-facebook"></i>
                                Sign In with
                                Facebook</a>
                        </div>
                    ...
                    <div class="col-md-6 col-sm-6 create-new-account">
                        ...
                        <form class="register-form outer-top-xs" role="form" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control unicase-form-control text-input"
                                    id="exampleInputEmail2" placeholder="Email" name="email" value="{{ old('email') }}">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="name" class="form-control unicase-form-control text-input"
