                        ...
                        <div class="card-body">
                            <article class="card">
                                <div class="card-body row" style="padding:10px;">
                                    ...
                                    <div class="col-md-5"> <strong>Shipping By: {{ $order->name }}</strong> <br>
                                        {{ $order->division->division_name }},{{ $order->district->district_name }},{{ $order->upzilla->upzilla_name }}
                                        | <i class="fa fa-phone"></i> {{ $order->phone }}</div>
                                    <div class="col-md-2"> <strong>Status:</strong> <br> {{ $order->payment_method }} </div>
                            ...
                            <div class="track">
                                ...
                                @elseif($order->status == 'picked')
                                    ...
                                    <div class="step active">
                                        ...
                                        <span class="text">Picked Order</span>
                                        <small
                                            class="text-danger">{{ Carbon\Carbon::parse($order->picked_date)->format('d F Y') }}</small>
                                    </div>
                                    <div class="step">
                                        <span class="icon"> <i class="fa fa-user"></i> </span>
                                        <span class="text">Shipped Order</span>
                                ...
                                @elseif($order->status == 'shipped')
                                    ...
                                    <div class="step">
                                        <span class="icon active"> <i class="fa fa-user"></i> </span>
                                        <span class="text">Shipped Order</span>
                                        <small
                                            class="text-danger">{{ Carbon\Carbon::parse($order->shipped_date)->format('d F Y') }}</small>
                                    </div>
                                    <div class="step">
                                        <span class="icon"> <i class="fa fa-hand-lizard-o"></i> </span>
                                        <span class="text">Delivered</span>
                                    ...
                                    @foreach ($orderItems as $item)
                                        <li class="col col-md-3 col-sm-6  mt">
                                            <figure class="itemside mb-3">
                                                <div class="aside"style="height: 50px; width:50px;"><img
                                                        src="{{ asset($item->product->product_thumbnail) }}">
                                                </div>
                                                <figcaption class="info align-self-center">
                                                    <p class="title"> {{ $item->product->product_name_en }}
                                                        <br>{{ $item->size }} <br>
                                                        {{ $item->color }}
