                                                ...
                                                <div class="accordion-heading">
                                                    <label class="form-check-label">
                                                        <input type="checkbox" class="form-check-input"
                                                            name="category[]" id=""
                                                            value="{{ $cat->category_slug_en }}"
                                                            @if (!empty($filterCat) && in_array($cat->category_slug_en, $filterCat)) checked @endif
                            ...
                            <div class="sidebar-widget wow fadeInUp">
                                ...
                                <div class="sidebar-widget-body m-t-10">
                                    ...
                                    <input type="hidden" id="price_range" name="price_range"
                                        value="@if (!empty($_GET['price'])) {{ $_GET['price'] }} @endif"><br>
                                    @if (!empty($_GET['price']))
                                        @php
                                            ...
                                            <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                                                <select name="sortBy" onchange="this.form.submit();"
                                                    ...
                                                    <option value="priceLowtoHigh"
                                                        @if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'priceLowtoHigh') selected @endif>Price:Lower
                                                        to
                                                        Higher</option>
                                                    <option value="priceHightoLow"
                                                        @if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'priceHightoLow') selected @endif>Price:Higher
                                                        to
                                                        Lower</option>
                                                    <option value="nameAtoZ"
                                                        @if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'nameAtoZ') selected @endif>
                                                        Product Name:A to Z</option>
                                                    <option value="nameZtoA"
                                                        @if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'nameZtoA') selected @endif>
