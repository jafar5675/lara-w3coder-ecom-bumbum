            ...
            @foreach ($categories as $cat)
                <li class="dropdown menu-item">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                            class="icon fa {{ $cat->category_icon }}" aria-hidden="true"></i>
                                        ...
                                        <ul class="links list-unstyled">
                                            ...
                                            @foreach ($subsubcategories as $subsubcat)
                                                <li>
                                                    @if (session()->get('language') == 'bangla')
                                                        <a
                                                            href="{{ url('sub/subcategory/product/' . $subsubcat->id . '/' . $subsubcat->subsubcategory_slug_bn) }}">
                                                            {{ $subsubcat->subsubcategory_name_bn }}
                                                        </a>
                                                    @else
                                                        <a
                                                            href="{{ url('sub/subcategory/product/' . $subsubcat->id . '/' . $subsubcat->subsubcategory_slug_en) }}">
