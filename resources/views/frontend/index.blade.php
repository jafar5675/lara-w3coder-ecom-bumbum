                                                    ...
                                                    <div class="col col-xs-7">
                                                        <div class="product-info">
                                                            ...
                                                            <div class="product-price">
                                                                @if (session()->get('language') == 'bangla')
                                                                    <span class="price">
                                                                        {{ bn_price($product->selling_price) }}</span>
                                                                @else
                                                                    <span class="price">
                                                                        {{ $product->selling_price }} </span>
                                                                @endif
                                            ...
                                            <div class="item item-carousel">
                                                <div class="products">
                                                    ...
                                                    <div class="product">
                                                        <div class="product-image">
                                                            <div class="image">
                                                                {{-- <a href="detail.html"><img src="{{ asset($product->product_thumbnail) }}"
                                                    alt=""></a> --}}
                                                                @if (session()->get('language') == 'bangla')
                                                                    <a
                                                                        href="{{ url('single/product/' . $product->id . '/' . $product->product_slug_bn) }}"><img
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                ...
                                <div class="product">
                                    ...
                                    <div class="product-info text-left">
                                        <h3 class="name"><a href="detail.html">Print</a></h3>
                                        @if (App\Models\ProductReview::where('product_id', $product->id)->first())
                                            @php
                                                // product review
                                                $reviewProducts = App\Models\ProductReview::where('product_id', $product->id)
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                ...
                                <div class="product">
                                    ...
                                    <div class="product-info text-left">
                                        <h3 class="name"><a href="detail.html">Floral</a></h3>
                                        @if (App\Models\ProductReview::where('product_id', $product->id)->first())
                                            @php
                                                // product review
                                                $reviewProducts = App\Models\ProductReview::where('product_id', $product->id)
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                ...
                                <div class="product">
                                    ...
                                    <div class="product-info text-left">
                                        <h3 class="name"><a href="detail.html">flower</a></h3>
                                        ...
                                        <div class="product-price">
                                            <span class="price">
                                                $4 </span>
                                            <span class="price-before-discount">$ 8</span>
