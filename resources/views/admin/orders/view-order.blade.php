                        ...
                        <li class="list-group-item">
                            ...
                            @elseif($order->status == 'confirm')
                                <a href="{{ url('admin/confirm-to-processing/' . $order->id) }}"
                                    class="btn btn-block btn-success" id="processing">Processing</a>
                            @elseif($order->status == 'processing')
                                <a href="{{ url('admin/processing-to-picked/' . $order->id) }}"
                                    class="btn btn-block btn-success" id="order">Picked</a>
                            @elseif($order->status == 'picked')
                                <a href="{{ url('admin/picked-to-shipped/' . $order->id) }}"
                                    class="btn btn-block btn-success" id="order">Shipped</a>
                            @elseif($order->status == 'shipped')
                                <a href="{{ url('admin/shipped-to-delivery/' . $order->id) }}"
                                    class="btn btn-block btn-success" id="order">Delevery</a>
                            @endif
                        </li>
                                ...
                                @foreach ($orderItems as $item)
                                    <tr>
                                        <td class="col-md-1"><img src="{{ asset($item->product->product_thumbnail) }}"
                                                height="50px;" width="50px;" alt="imga"></td>
                                        <td class="col-md-3">
